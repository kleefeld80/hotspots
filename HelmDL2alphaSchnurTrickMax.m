function HelmDL2alphaSchnurTrickMax(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    [x,mai]=fminsearch(@computevalue,[0;0.6875],options)
    [x,mii]=fminsearch(@computevalue2,[0;-0.6875],options)
    ...
    if yes
       ...
       save('complexSchnur1.mat','z')
       plotthething2('complexSchnur1.eps',xx,yy,real(z),outer,inner,12,[-2,-1.5,-1,-0.5,0,0.5,1,1.5,2],[-2,-1.5,-1,-0.5,0,0.5,1,1.5,2])
