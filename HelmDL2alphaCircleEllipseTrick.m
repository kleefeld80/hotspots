function HelmDL2alphaCircleEllipseTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    ii=0:1:nnn;
    ti=2*pi*ii/nnn;
    outer=[a*cos(ti);b*sin(ti)]; % Circle and Ellipse
    a=0.15;
    b=0.35;
    inner=fliplr([-0.5+a*cos(ti);-0.3+b*sin(ti)]);
    ...
    if yes
       ...
       save('circelli.mat','z')
       plotthething2('circelli.eps',xx,yy,real(z),outer,inner,12,[-1,-0.5,0,0.5,1],[-1,-0.5,0,0.5,1])
