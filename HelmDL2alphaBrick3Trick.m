function HelmDL2alphaBrick2Trick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    if yes
       ...
       save('brick2.mat','z')
       plotthething2('brick2.eps',xx,yy,real(z),outer,inner,12,[-2.5,-2,-1.5,-1,-0.5,0,0.5,1,1.5,2,2.5],[-2.5,-2,-1.5,-1,-0.5,0,0.5,1,1.5,2,2.5])
