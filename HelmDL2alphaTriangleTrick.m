...
% n=  6 ns=  3   0.0270964970493353  (l=5, else l=10)
% n= 12 ns=  5   0.002072291237633     3.708807679285383
% n= 24 ns=  9   9.784308853919283e-05 4.404613016839625
% n= 48 ns= 17   4.155591367245398e-06 4.557344243598836
% n= 96 ns= 33   1.706376465588175e-07 4.606045918008181
% n=192 ns= 65   6.900058446434516e-09 4.628183580811736
% n=384 ns=129   2.758070213106734e-10 4.644877492586735
% n=768 ns=257   1.087967287840423e-11 4.663952099971287
function HelmDL2alphaTriangleTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    s=linspace(0,1,n);
    p1=[-1/2;         0]*(1-s)+[ 1/2;         0]*s;
    p2=[ 1/2;         0]*(1-s)+[   0; sqrt(3)/2]*s;
    p3=[   0; sqrt(3)/2]*(1-s)+[-1/2;         0]*s;
    vi=[p1(:,1:n-1) p2(:,1:n-1) p3];
    n=length(vi)-1
    faces=n/2;
    outer=vi;
    ...
    if yes
        ...
        save('triangle.mat','z')
       plotthething('triangle.eps',xx,yy,real(z),outer,12,[-1,-0.5,0,0.5,1],[-1,-0.5,0,0.5,1])
