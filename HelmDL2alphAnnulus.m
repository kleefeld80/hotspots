function HelmDL2alphAnnulus(ns)
    global alpha
       global l
  global m
  global N
...
function E=intDL(x1s,x2s,x3s,y1s,y2s,y3s,xhs,yhs,ks,basisf,check)
  ...
  if check==0
    E=quadgk(@c11_1,0,1,'AbsTol',1e-7);
  elseif check==1
    E=quadgk(@c11_1,0,alpha,'AbsTol',1e-7)+quadgk(@c11_1,alpha,1,'AbsTol',1e-7);
  elseif check==2
    E=quadgk(@c11_1,0,0.5,'AbsTol',1e-7)+quadgk(@c11_1,0.5,1,'AbsTol',1e-7);
  elseif check==3
    E=quadgk(@c11_1,0,1-alpha,'AbsTol',1e-7)+quadgk(@c11_1,1-alpha,1,'AbsTol',1e-7);
  else
