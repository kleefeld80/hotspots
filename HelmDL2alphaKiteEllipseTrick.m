function HelmDL2alphaKiteEllipseTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    a=0.15;
    b=0.35;
    inner=fliplr([-0.1+a*cos(ti);-0.3+b*sin(ti)]);
    ...
    if yes
       ...
       save('kiteelli.mat','z')
       plotthething2('kiteelli.eps',xx,yy,real(z),outer,inner,12,[-1,-0.5,0,0.5,1],[-1,-0.5,0,0.5,1])
