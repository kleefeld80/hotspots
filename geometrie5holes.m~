function points=geometrie5holes(n)
  eps=1/2;
  ...
  mux=2;
  muy=-2.75;
  pointsp5=fliplr([mux+R*cos(ti);muy+R*sin(ti)]);
  ...
  mux=-2;
  muy=-2.75;
  pointsp6=fliplr([mux+R*cos(ti);muy+R*sin(ti)]);
  
  points=[pointsp1 pointsp2 pointsp3 pointsp4 pointsp5 pointsp6];
