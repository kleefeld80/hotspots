function points=geometrie2(n)
  eps=0.5;
  
  % Part 1
  points1=ellipsepart(2,8*eps,1,2*eps,-pi/2,-pi,n,1);
  ...
  points1=[points1 ellipsepart(-2,8*eps,1,2*eps,0,-pi/2,n,0)];
  ...
  %points1=[points1 ellipsepart(-2,8*eps,1,2*eps,0,pi,n,1)];
  points1=[points1 ellipsepart(-2,8*eps,1,2*eps,0,-pi/2,n,0)];
  pointsrand=ellipsepart(-2,0,6*eps,6*eps,pi/2,3*pi/2,n,1);          % 3. Arg 6->8
  points2(2,:)=-points2(2,:);
  pointsrand2=ellipsepart(2,0,6*eps,6*eps,-pi/2,pi/2,n,0);
  pointsp1=[points1(:,1:end-1) pointsrand points2(:,1:end-1) pointsrand2];
  
  % Part2
  points1=ellipsepart(2,3*eps,1,2*eps,pi/2,pi,n,1);
  ...
  points1=[points1 ellipsepart(-2,3*eps,1,2*eps,0,pi/2,n,0)];
  pointsrand=ellipsepart(-2,0,5*eps,5*eps,pi/2,3*pi/2,n,1);     % 7->5
  points2=fliplr(points1);
  points2(2,:)=-points2(2,:);
  pointsrand2=ellipsepart(2,0,5*eps,5*eps,-pi/2,pi/2,n,0);
