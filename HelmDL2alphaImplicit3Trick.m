function HelmDL2alphaImplicit3Trick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    if yes
        ...
        save('implicit3.mat','z')
       plotthething('implicit3.eps',xx,yy,real(z),outer,12,[-1.5,-1,-0.5,0,0.5,1,1.5],[-1.5,-1,-0.5,0,0.5,1,1.5])
