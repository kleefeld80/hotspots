...
% n=   8 ns=  3  0.007358578112518
% n=  16 ns=  5  4.422573394266201e-04 4.056469033027898
% n=  32 ns=  9  1.906017713537634e-05 4.536252653099946
% n=  64 ns= 17  7.697364696395752e-07 4.630053113816923
% n= 128 ns= 33  3.052677820957560e-08 4.656217361996937
% n= 256 ns= 65  1.204214934906502e-09 4.663910515475183
% n= 512 ns=129  4.742881354762622e-11 4.666185325777216
% n=1024 ns=257  1.866479796504879e-12 4.667371981673494
function HelmDL2alphaSquareTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    vi=[xxx(1:end-1) yyy+1 fliplr(xxx(2:end)) yyy 0; yyy xxx(1:end-1) yyy+1 fliplr(xxx(2:end)) 0];
    n=length(vi)-1
    faces=n/2
    ...
    if yes
        ...
        save('square.mat','z')
       plotthething('square.eps',xx,yy,real(z),outer,12,[-1,-0.5,0,0.5,1],[-1,-0.5,0,0.5,1])
