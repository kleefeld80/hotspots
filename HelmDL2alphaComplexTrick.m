function HelmDL2alphaComplexTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    if yes
       ...
       %mai/mar
       %mii/mir
       plotthething2('complex1test.eps',xx,yy,real(z),outer,inner,12,[-2,-1.5,-1,-0.5,0,0.5,1,1.5,2],[-2,-1.5,-1,-0.5,0,0.5,1,1.5,2])
       %pause
       x=linspace(-0.6,0.6,reso);
        ...
        save('complex2test.mat','z')
       plotthething3('complex2test.eps',xx,yy,real(z),outer,inner,13,[-0.5,0,0.5],[0.5,1])
       x=linspace(-0.6,0.6,reso);
        ...
        save('complex3test.mat','z')
       plotthething4('complex3test.eps',xx,yy,real(z),outer,inner,14,[-0.5,0,0.5],[-1,-0.5])
    end
    pause
    end
    end
