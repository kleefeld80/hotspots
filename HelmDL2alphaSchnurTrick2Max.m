function HelmDL2alphaSchnurTrick2Max(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    [x,mai]=fminsearch(@computevalue,[0;0.69],options)
    [x,mii]=fminsearch(@computevalue2,[0;-0.69],options)
    ...
    if yes
       ...
       save('complexdelta005.mat','z')
       plotthething2('complexSchnur005.eps',xx,yy,real(z),outer,inner,12,[-2,-1.5,-1,-0.5,0,0.5,1,1.5,2],[-2,-1.5,-1,-0.5,0,0.5,1,1.5,2])
