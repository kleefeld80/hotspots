...
% n= 12 ns=  3   2.18215310893707359 + 0.00258225761166378i
% n= 24 ns=  5   2.19526096203349e+000 + 1.84160599050108e-004i
% n= 48 ns=  9   2.20191519890974e+000 + 7.69051479224372e-006i
% n= 96 ns= 17   2.20490084437573e+000 + 3.13886460410648e-007i
% n=192 ns= 33   2.20625644097571e+000 + 1.26779488025544e-008i
% n=384 ns= 65   2.20687117387430e+000 + 5.10329732535334e-010i
% n=768 ns=129   

function HelmDL2alphaPshapeTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    if yes
        ...
        save('pshape.mat','z')
       plotthething('pshape.eps',xx,yy,real(z),outer,12,[-1,-0.5,0,0.5,1],[-1,-0.5,0,0.5,1])
