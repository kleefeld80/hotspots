...
% n= 10 ns=  3   2.72438734492862356 + 0.00619308273075397i
% n= 20 ns=  5   2.72475886425255e+000 + 3.61491394381114e-004i
% n= 40 ns=  9   2.72535138602655e+000 + 1.51570411220337e-005i
% n= 80 ns= 17   2.72549365690736e+000 + 5.76860172298470e-007i
% n=160 ns= 33   2.72553831627780e+000 + 1.28913146925383e-008i
% n=320 ns= 65   2.72555296878034e+000 - 1.93091543371070e-009i
% n=640 ns=129   

function HelmDL2alphaTshapeTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    p4=[1;1]*(1-s)+[0;2]*s;
    p5=[0;2]*(1-s)+[0;0]*s;
    vi=[p1(:,1:n-1) p2(:,1:n-1) p3(:,1:n-1) p4(:,1:n-1) p5]/2;
    n=length(vi)-1
    faces=n/2;
    outer=vi;
