function HelmDL2alphaKiteKiteTrick(ns)
    global alpha
  global l
  global m
  global N
  ...
  wavenumber=1;
    ...
    ii=0:1:nnn;
    ti=2*pi*ii/nnn;
    outer=[0.75*cos(ti)+0.3*cos(2*ti);sin(ti)]; % Circle and Ellipse
    a=0.15;
    b=0.35;
    inner=0.5*[sin(ti)+0.5;0.75*cos(ti)+0.3*cos(2*ti)];
    ...
    if yes
       ...
       save('kitekite.mat','z')
       plotthething2('kitekite.eps',xx,yy,real(z),outer,inner,12,[-1,-0.5,0,0.5,1],[-1,-0.5,0,0.5,1])
